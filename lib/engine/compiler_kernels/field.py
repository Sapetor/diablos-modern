...
def build_fieldprobe(ctx):
    ...
    def exec_fieldprobe(
        t, y, dy_vec, signals, _src=src, _pos_src=pos_src, _position=position, _mode=mode, _L=L
    ):
...
def build_fieldprobe2d(ctx):
    ...
    def exec_fieldprobe2d(
        t,
        y,
        dy_vec,
        signals,
        _src=src,
        _x_pos_src=x_pos_src,
        _y_pos_src=y_pos_src,
        _x_pos=x_position,
        _y_pos=y_position,
        _mode=position_mode,
        _Lx=Lx,
