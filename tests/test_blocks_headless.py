...
def test_diagram_builder():
    ...
    step = builder.add_block(
        "Step", x=50, y=100, name="step", params={"start_time": 0.0, "h_start": 0.0, "h_final": 1.0}
    )
    gain = builder.add_block("Gain", x=150, y=100, name="gain", params={"gain": 2.0})
