...
Every diagram in this folder loads, runs headlessly and produces finite Scope
data — `tests/integration/test_example_gallery.py` runs all of them on every
push. Start at [`first_order_step_response.diablos`](first_order_step_response.diablos)
and work down.
...
### [`first_order_step_response.diablos`](first_order_step_response.diablos)
...
### [`pi_loop_three_plants.diablos`](pi_loop_three_plants.diablos)
...
### [`test_demux_logic.diablos`](test_demux_logic.diablos)
...
### [`pid_second_order.diablos`](pid_second_order.diablos)
...
### [`c01_tank_feedback.diablos`](c01_tank_feedback.diablos)
...
### [`c02_vehicle_single_agent.diablos`](c02_vehicle_single_agent.diablos)
...
### [`c03_bode_frequency_response.diablos`](c03_bode_frequency_response.diablos)
...
### [`c05_mass_spring_state_space.diablos`](c05_mass_spring_state_space.diablos)
...
### [`c05_lqr_vs_open_loop.diablos`](c05_lqr_vs_open_loop.diablos)
...
### [`c06_lqr_state_feedback.diablos`](c06_lqr_state_feedback.diablos)
...
### [`c06_observer_estimation.diablos`](c06_observer_estimation.diablos)
...
### [`inverted_pendulum_lqr.diablos`](inverted_pendulum_lqr.diablos)
...
### [`pendulum_nonlinear_vs_linear.diablos`](pendulum_nonlinear_vs_linear.diablos)
...
### [`van_der_pol_stiff.diablos`](van_der_pol_stiff.diablos)
...
### [`relay_thermostat_events.diablos`](relay_thermostat_events.diablos)
...
### [`nonlinear_blocks.diablos`](nonlinear_blocks.diablos)
...
### [`discrete_pi_zoh.diablos`](discrete_pi_zoh.diablos)
...
### [`multirate_demo.diablos`](multirate_demo.diablos)
...
[Multi-Rate](../docs/wiki/Multi-Rate.md) page for the full treatment.

---

## Networks and multi-agent systems

### [`c02_string_instability.diablos`](c02_string_instability.diablos)
...
### [`c08_consensus_ring.diablos`](c08_consensus_ring.diablos)
...
### [`c08_consensus_topology.diablos`](c08_consensus_topology.diablos)
...
### [`c09_formacion_distancia.diablos`](c09_formacion_distancia.diablos)
...
### [`c11_opinion_dynamics.diablos`](c11_opinion_dynamics.diablos)
...
### [`c12_sis_epidemics.diablos`](c12_sis_epidemics.diablos)
...
### [`c12x_kuramoto_sync.diablos`](c12x_kuramoto_sync.diablos)
...
### [`c13_distributed_subgradient.diablos`](c13_distributed_subgradient.diablos)
...
### [`optimization_basic_demo.diablos`](optimization_basic_demo.diablos)
...
### [`optimization_pid_tuning_demo.diablos`](optimization_pid_tuning_demo.diablos)
...
### [`optimization_constrained_demo.diablos`](optimization_constrained_demo.diablos)
...
### [`optimization_data_fit_demo.diablos`](optimization_data_fit_demo.diablos)
...
### [`gradient_descent_simple.diablos`](gradient_descent_simple.diablos)
...
### [`gradient_descent_demo.diablos`](gradient_descent_demo.diablos)

The same descent at α = 0.1 with a `ResidualNorm` on the gradient, so you can
watch `‖∇f‖` decay geometrically alongside the cost.

### [`gradient_descent_verification.diablos`](gradient_descent_verification.diablos)
...
### [`momentum_demo.diablos`](momentum_demo.diablos)
...
### [`adam_demo.diablos`](adam_demo.diablos)
...
### [`newton_method_demo.diablos`](newton_method_demo.diablos)
...
### [`newton_method_verification.diablos`](newton_method_verification.diablos)

The same system from [0.8, 0.2], measured against the exact root [1, 0]. Both
`‖x − x*‖` and `‖F(x)‖` should reach 1e-10 or below.

### [`linear_system_demo.diablos`](linear_system_demo.diablos)
...
### [`linear_system_verification.diablos`](linear_system_verification.diablos)

The same solve, with `‖x − x*‖` against the exact [1.6, 1.8] and the residual
`‖Ax − b‖` on `Display` blocks. Both should read below 1e-14.

### [`learning_rate_comparison.diablos`](learning_rate_comparison.diablos)
...
### [`optimizer_comparison.diablos`](optimizer_comparison.diablos)
...
### [`convergence_rates.diablos`](convergence_rates.diablos)
...
### [`heat_equation_demo.diablos`](heat_equation_demo.diablos)
...
### [`wave_equation_demo.diablos`](wave_equation_demo.diablos)
...
### [`advection_equation_demo.diablos`](advection_equation_demo.diablos)
...
### [`diffusion_reaction_demo.diablos`](diffusion_reaction_demo.diablos)
...
### [`heat_equation_2d_demo.diablos`](heat_equation_2d_demo.diablos)
...
### [`pde_comparison_demo.diablos`](pde_comparison_demo.diablos)
...
### [`pde_neumann_bc_demo.diablos`](pde_neumann_bc_demo.diablos)
...
### [`heat_equation_1d_verification.diablos`](heat_equation_1d_verification.diablos)

`T(x, 0) = sin(πx/L)` decays as `exp(−απ²t/L²)` with the shape preserved; the
error scope should stay near zero.

### [`wave_equation_1d_verification.diablos`](wave_equation_1d_verification.diablos)

`u(x, t) = sin(πx/L)·cos(πct/L)`: a standing wave of period 2L/c = 2 s.

### [`advection_equation_1d_verification.diablos`](advection_equation_1d_verification.diablos)
...
### [`diffusion_reaction_1d_verification.diablos`](diffusion_reaction_1d_verification.diablos)

`c(x, t) = sin(πx/L)·exp(−(Dπ²/L² + k)t)`: diffusion and reaction contribute
additively to the decay rate.

### [`heat_equation_2d_verification.diablos`](heat_equation_2d_verification.diablos)
...
### [`monte_carlo_robustness.diablos`](monte_carlo_robustness.diablos)
...
### [`library_block_demo.diablos`](library_block_demo.diablos)
...
The same block is published as a library block in [`library/`](library/):
...
2. Save it here as `<topic>_<what_it_shows>.diablos`.
3. Add a paragraph to this file **and** to
   [`docs/wiki/Examples.md`](../docs/wiki/Examples.md) — a test fails if either
