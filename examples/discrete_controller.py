...
def create_discrete_example():
    ...
    builder.add_block(
        "Sine", 50, 150, name="sine", params={"amplitude": 1.0, "frequency": 2.0, "phase": 0.0}
    )
    ...
    builder.add_block(
        "DiscreteTF", 350, 200, name="dtf", params={"numerator": [0.5], "denominator": [1.0, -0.5]}
    )
    ...
    builder.add_block(
        ...
        100,
        name="scope_orig",
        params={"title": "Original Signal", "labels": "continuous"},
    )

    # Scope for ZOH output
    builder.add_block(
        "Scope", 400, 200, name="scope_zoh", params={"title": "ZOH Output", "labels": "sampled"}
    )
    ...
    builder.add_block(
        ...
        300,
        name="scope_filt",
        params={"title": "Filtered Output", "labels": "filtered"},
    )
