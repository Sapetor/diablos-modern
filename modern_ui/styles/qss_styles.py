...
def _build_qpalette() -> QPalette:
    ...
    p = QPalette()
    p.setColor(Role.Window, window_bg)
    p.setColor(Role.WindowText, text)
    p.setColor(Role.Base, surface)
    p.setColor(Role.AlternateBase, panel_bg)
    p.setColor(Role.Text, text)
    p.setColor(Role.PlaceholderText, text_dim)
    p.setColor(Role.Button, panel_bg)
    p.setColor(Role.ButtonText, text)
    p.setColor(Role.BrightText, error)
    p.setColor(Role.ToolTipBase, surface)
    p.setColor(Role.ToolTipText, text)
    p.setColor(Role.Highlight, accent)
    p.setColor(Role.HighlightedText, white)
    p.setColor(Role.Link, accent)
    p.setColor(Role.LinkVisited, accent)

    p.setColor(Group.Disabled, Role.WindowText, text_off)
    p.setColor(Group.Disabled, Role.Text, text_off)
    p.setColor(Group.Disabled, Role.ButtonText, text_off)
    p.setColor(Group.Disabled, Role.Highlight, panel_bg)
    p.setColor(Group.Disabled, Role.HighlightedText, text_off)
    return p
